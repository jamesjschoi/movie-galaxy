          ...
          <div className="about-info">
            <div className="info-left">
              <div className="info-left-box">
                <p>Movie Galaxy provides movie listings in 4 categories:<span> popular, top-rated, coming soon </span>and<span> now playing </span>. While finding movie information, go ahead and click on the heart icon below the movie poster to make them appear in your favourite page!</p>
              </div>
            </div>
